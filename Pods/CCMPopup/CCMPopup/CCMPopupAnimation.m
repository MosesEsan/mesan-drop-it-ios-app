...
//        blurredBackground = [[UIImageView alloc] initWithImage:[[UIImage screenshot] applyBlurWithRadius:5.0 tintColor:[UIColor colorWithRed:20/255.0 green:36/255.0 blue:47/255.0 alpha:0.6] saturationDeltaFactor:1.0 maskImage:nil]];
        blurredBackground = [[UIImageView alloc] initWithImage:[[UIImage screenshot] applyBlurWithRadius:popupTransitioning.backgroundBlurRadius tintColor:[[UIColor blackColor] colorWithAlphaComponent:0.6] saturationDeltaFactor:1.0 maskImage:nil]];
    }
